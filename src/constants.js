...
import mctLogo from './assets/company_logo/mct.png';
import spotLogo from './assets/company_logo/sportspot.png';
import cortexLogo from './assets/company_logo/cortex.png';

// Education Section Logo's
import glaLogo from './assets/education_logo/gla_logo.png';
import bsaLogo from './assets/education_logo/bsa_logo.png';
import vpsLogo from './assets/education_logo/vps_logo.png';
import auiLogo from './assets/education_logo/AUI-Logo.png';
  ...
  export const experiences = [
    {
      ...
      date: "2024 - Present",
      desc: `I founded Moroccan Code Together, a growing tech community with an active Discord server where learners, developers, and creators come together to collaborate and grow.`+
      `Inside the community, members can:`+
      `✨ Access free courses with certificates to enhance their skills 🎓`+
      `⚡ Stay updated on hackathons and coding events 💻`+
      `📰 Explore the latest tech news and trends 🌍`+
      `🤝 Connect and collaborate on exciting projects 💡`+
      `🚀 Share ideas in entrepreneurship channels and get real feedback 🌱`+
      `Our mission is to empower Moroccan tech enthusiasts by providing a space to learn, build, and inspire one another.`,
      skills: [
  ...
  export const education = [
    {
      id: 0,
      img: auiLogo,
      school: "Al Akhawayn University, Ifrane",
      date: "Sept 2023 - Present",
      grade: "Ongoing",
      desc: "",
      degree: "Bachelor of Science in "+
      "Computer Science : Artificial Intelligence BSCSAI",
    },
  ];
